...
public final class ItemProductSearchBinding implements ViewBinding {
  ...
  private ItemProductSearchBinding(@NonNull MaterialCardView rootView,
      ...
      @NonNull TextView productReviews) {
  ...
  public static ItemProductSearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.productReviews;
      TextView productReviews = ViewBindings.findChildViewById(rootView, id);
      if (productReviews == null) {
        break missingId;
      }

      return new ItemProductSearchBinding((MaterialCardView) rootView, productDescription,
          productImage, productName, productPrice, productReviews);
    }
